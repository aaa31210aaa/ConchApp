...
import static utils.OpenApk.fileName;
...
public class CheckVersion {
     ...
     * 检查版本
     */
    public void CheckVersions(Context context, String tag) {
     ...
     * 打开更新提示dialog
     */
    public void OpenDialog(String appmemo, String url, Context context) {
     ...
     * @param downloadUrl
     */
    public void DownLoadFile(String downloadUrl, Context context) {

...
public class MonthPlan extends BaseFragment {
    private View view;
...
//    private LinearLayout.LayoutParams tvLps;
    ...
    @BindView(R.id.month_plan_refresh)
    SmartRefreshLayout month_plan_refresh;
    ...
    public View makeView() {
        view = View.inflate(getActivity(), R.layout.fragment_month_plan, null);
        //绑定fragment
                    ...
                    public void onSuccess(Response<String> response) {
                        try {
                            ...
                            if (jsonObject.getString(CODE).equals(SUCCESS_CODE)) {
                                production_mplan.removeAllViews();
...
//                                                intent.putExtra("type", MyData.MONTH);
...
//                                        production_yplan.addView(llw);
                            ...
                            month_plan_refresh.finishRefresh();
    ...
    private void initRefresh() {
        //刷新
        month_plan_refresh.setOnRefreshListener(new OnRefreshListener() {
            @Override
        ...
        //加载
        month_plan_refresh.setOnLoadmoreListener(new OnLoadmoreListener() {
            @Override
        ...
        public void dispatchMessage(Message msg) {
            ...
            switch (msg.what) {
                case 0:
                    ...
                    month_plan_refresh.finishLoadmore();
                    break;
                case 1:
